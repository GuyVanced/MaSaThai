...
public class ImgBasedController {
    ...
    private String correctChoice = "A. Georgetown";
    private int c_id,points;
    private Map<Integer, String> selectedChoicesMap = new HashMap<>();
    private int currentQuestionNumber;

    private String email, fullName, gender,flagPath, nationality;
